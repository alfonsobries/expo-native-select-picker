Pod::Spec.new do |s|
  ...
  s.homepage       = 'https://github.com/alfonsobries/expo-native-select-picker'
  s.platforms      = {
    :ios => '16.4',
    :tvos => '16.4'
  }
  s.source         = { git: 'https://github.com/alfonsobries/expo-native-select-picker.git' }
